...
COPY cuisines (id, food_type) FROM stdin;
1	
2	
3	food
4	food
...
SELECT pg_catalog.setval('cuisines_id_seq', 6, true);
...
COPY restaurants (id, restaurant_name, cuisine_id) FROM stdin;
1	flower	5
2	flower	5
3	daisy	5
4	daisy	5
...
SELECT pg_catalog.setval('restaurants_id_seq', 9, true);
